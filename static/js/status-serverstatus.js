	...
	$.getJSON("json/stats.json", function(result) {
		...
		for (var i = 0, rlen=result.servers.length; i < rlen; i++) {
			...
			if (!TableRow.length) {
				$("#servers").append(
					"<tr id=\"r" + i + "\" data-toggle=\"collapse\" data-target=\"#rt" + i + "\" class=\"accordion-toggle " + hack + "\">" +
						"<td style=\"width: 5%;\" id=\"online4\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
						"<td style=\"width: 5%;\" id=\"online6\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
						"<td id=\"name\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"type\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"location\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"uptime\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"load\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"network\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"traffic\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></td>" +
						"<td id=\"cpu\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
						"<td id=\"memory\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
						"<td id=\"hdd\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
						"<td id=\"ping\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></small></div></div></td>" +
					"</tr>" +
					"<tr class=\"expandRow " + hack + "\"><td colspan=\"16\"><div class=\"accordian-body collapse\" id=\"rt" + i + "\">" +
						"<div id=\"expand_mem\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
						"<div id=\"expand_swap\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
						"<div id=\"expand_hdd\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
						"<div id=\"expand_tupd\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
						"<div id=\"expand_ping\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
						"<div id=\"expand_custom\"><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-spinner'></i></div>" +
					"</div></td></tr>"
				);
			...
			if (result.servers[i].online4) {
				...
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa fa-check'></small>";
			} else {
				TableRow.children["online4"].children[0].children[0].className = "progress-bar progress-bar-danger";
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-times'></small>";
			}

			// Online6
			if (result.servers[i].online6) {
				TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-success";
				TableRow.children["online6"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa fa-check'></small>";
			} else {
				TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-danger";
				TableRow.children["online6"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-times'></small>";
			}
			...
			if (!result.servers[i].online4 && !result.servers[i].online6) {
				if (server_status[i]) {
					...
					TableRow.children["cpu"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 17px;top: 3px;\" class='fa fa-times-circle'></i></small>";
					...
					TableRow.children["memory"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 17px;top: 3px;\" class='fa fa-times-circle'></i></small>";
					...
					TableRow.children["hdd"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 17px;top: 3px;\" class='fa fa-times-circle'></i></small>";
					...
					TableRow.children["ping"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 17px;top: 3px;\" class='fa fa-times-circle'></i></small>";
		...
		if (!error) {
			$("#servers > tr.accordion-toggle").each(function(i) {
				...
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["online6"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				//TableRow.children["ip_status"].children[0].children[0].className = "progress-bar progress-bar-error";
				//TableRow.children["ip_status"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["uptime"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["uptime"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["load"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["load"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["network"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["network"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["traffic"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["traffic"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["cpu"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["cpu"].children[0].children[0].style.width = "100%";
				TableRow.children["cpu"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["memory"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["memory"].children[0].children[0].style.width = "100%";
				TableRow.children["memory"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["hdd"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["hdd"].children[0].children[0].style.width = "100%";
				TableRow.children["hdd"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				TableRow.children["ping"].children[0].children[0].className = "progress-bar progress-bar-error";
				TableRow.children["ping"].children[0].children[0].style.width = "100%";
				TableRow.children["ping"].children[0].children[0].innerHTML = "<small><i style=\"position: relative;font-size: 13px;top: 2px;\" class='fa fa-exclamation-circle'></i></small>";
				if(ExpandRow.hasClass("in")) {
					ExpandRow.collapse("hide");
				}
				TableRow.setAttribute("data-target", "");
		...
		error = 1;
		$("#updated").html("<i style=\"position: relative;font-size: 25px;top: 2px;\" class='fa fa-exclamation-circle'></i>.");
	});
}
